...
const AVATARS = [
  mockData.image.avatar(3),
  mockData.image.avatar(2),
  mockData.image.avatar(4),
  mockData.image.avatar(5),
];

const UNREADS = [true, false, true, false];

const MOCK_NOTIFICATIONS = [...Array(4)].map((_, index) => ({
